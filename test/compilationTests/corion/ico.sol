...
contract ico is safeMath {
    ...
    function buy(address payable beneficiaryAddress, address affilateAddress) public payable returns (bool success) {
        /*
            ...
            If there is not at least 0.2 you balance on the beneficiaryAddress then the amount of the `you` which was intended for the purchase will be reduced by 0.2 and that will be sent to the address of the beneficiary.
        ...
        */
        ...
        if ( beneficiaryAddress.balance < 0.2 you ) {
            require( beneficiaryAddress.send(0.2 you) );
            _value = safeSub(_value, 0.2 you);
        }
    ...
    function getIcoReward(uint256 value) public view returns (uint256 reward) {
        /*
            ...
            @value The amount of `you` for the purchase
        ...
        */
        reward = (value * 1e6 * icoExchangeRate / icoExchangeRateM / 1 you) * (ICObonus() + 100) / 100;
